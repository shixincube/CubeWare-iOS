...
@interface CWCustomAlertView(){
    id <CWCustomAlertViewDelegate> _delegate;
    UIView *_backgroundView;
    NSInteger _defaultlimitLength;
}
...
@property (nonatomic, copy) CWCustomAlertBlock alertBlock;
@end

@implementation CWCustomAlertView
...
- (void)setTextLimitLength:(NSInteger)textLimitLength{
    _defaultlimitLength = textLimitLength;
}
